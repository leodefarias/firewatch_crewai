...
echo "   docker-compose up firewatch-mysql firewatch-redis -d"
echo ""
...
echo ""
echo "📚 For detailed instructions, see: SETUP_WHATSAPP.md"
echo ""
echo "🆘 Need help? Check the troubleshooting section in SETUP_WHATSAPP.md"